...
/*  */
inline static void list_init(list_t *link)
{
    link->prev = link;
    link->next = link;
}
...
/*  */
inline static  int list_is_empty(list_t *link)
{
    return ( link->next == link );
}

/*  */
inline static  void __list_insert(list_t *prev,
                                  list_t *next,
                                  list_t *node)
{
    next->prev = node;
...
/*  */
inline static  void list_remove_node(list_t *node)
{
